...
$form['user_postal_code'] = $_POST['user_user_postal_code'];
...
$user->departments_id = $form['departments_id'];
$user->locomotions_id = $form['locomotions_id'];
$user->postal_code = $form['user_postal_code'];
